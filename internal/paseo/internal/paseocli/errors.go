...
var (
	...
	ErrInvalidWorkspaceMutation    = errors.New("некорректный запрос создания workspace paseo")
	ErrInvalidSessionMutation      = errors.New("некорректный запрос создания сессии paseo")
	ErrInvalidArchiveSessionID     = errors.New("некорректный идентификатор архивируемой сессии")
